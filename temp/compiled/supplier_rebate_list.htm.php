...
<div class="list-div">
    <div class="rebate-detaile">
        <div class="rebate_item rebate_shop-item">
            <div class="item-hd">
                <p>佣金抽成总额</p>
                <p><?php echo self::$_var['main_info']['rebate_money']; ?>元</p>
            </div>
        </div>
        <div class="rebate_item rebate_goods-item">
            <div class="item-hd">
                <p>平台收入总额</p>
                <p>+<?php echo self::$_var['main_info']['all_money']; ?>元</p>
            </div>
        </div>
        <div class="rebate_item rebate_order-item">
            <div class="item-hd">
                <p>平台支出总额</p>
                <p>-<?php echo self::$_var['main_info']['result_money']; ?>元</p>
            </div>
        </div>
    </div>
</div>
...
?>
    ...
    <div style="float: right ;margin-top: -37px "><a class="button_round" href="index.php?act=suprebate&op=xiajia"><?php echo self::$_var['msg']; ?></a></div>
</div>
...
?>
            <tr>
                <td align="center"><?php echo self::$_var['supplier']['supplier_name']; ?></td>
                <td align="center">+<?php echo self::$_var['supplier']['all_money']; ?></td>
                <td align="center">-<?php echo self::$_var['supplier']['rebate_money']; ?></td>
                <td align="center"><?php echo self::$_var['supplier']['result_money']; ?></td>
                <td align="center"><a href="index.php?act=suprebate&op=view&suppid=<?php echo self::$_var['supplier']['supplier_id']; ?>" title="查看"><img src="templates/default/images/icon_view.gif" border="0" height="16" width="16" /></a></td>
            </tr>
            <?php endforeach; else: ?>
