                  ...
                  $.ajax({
                      ...
                      success:function(rev){
                          ...
                          for(var i = 0;i<json_obj.length;i++){
                              ...
                              if(enabled==1){
                                  var panduan="<img src='<?php echo self::$_var['urls_dir']; ?>/images/yes.gif'>"
                              }
                              //分页相关  html
