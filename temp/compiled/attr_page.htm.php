    ...
    $(function(){
        ...
        function chuan(page){
            ...
            $.ajax({
                ...
                data:{"pagenum":page,"length":length,'request':1,"goods_type":"<?php echo self::$_var['goods_type']; ?>"},
                method:"get",
                success:function(rev){
                    ...
                    for(var i = 0;i<json_obj.length;i++){
                        //分页相关  html
                        $('#trr').before("<tr class='item'><td>"+json_obj[i].attr_id+"</td><td>"+json_obj[i].attr_name+"</td><td>"+json_obj[i].type_name+"</td><td>"+json_obj[i].fs+"</td><td>"+json_obj[i].attr_values+"</td><td>"+json_obj[i].sort_order+"</td><td><a href='index.php?act=attribute&op=attr_edit&attr_id= "+json_obj[i].attr_id+"'><img src='templates/default/images/icon_edit.gif' border='0' height='16' width='16'></a><a href='index.php?act=attribute&op=attr_edit&attr_id= "+json_obj[i].attr_id+"'><img src='templates/default/images/icon_drop.gif' border='0' height='16' width='16'></a></td></tr>");
