...
<html>
    ...
    <head>
        ...
        <title><?php echo self::$_var['app_name']; ?></title>
        ...
        <style type="text/css">
            ...
            #header-div {
                ...
                background:url(templates/default/images/top_bg.gif) repeat-x;
            ...
            #admininfo-div span.left{float:left;height:68px; line-height:58px;background:url(templates/default/images/ui_04.png) no-repeat 10px 12px; text-indent:30px; color:#d2d4d1;}

            #admininfo-div span.right{float:left;height:68px; line-height:58px;background:url(templates/default/images/ui_17.png) no-repeat 5px 13px; text-indent:20px; color:#e9e9e9;}
            ...
            #submenu-div li {
                ...
                width:77px;  text-align:center; height:68px; background:url(templates/default/images/top_line.gif) no-repeat left top;

            }

            #submenu-div li a{

                display:block; background:url(templates/default/images/top_header.png) no-repeat left top; padding-top:30px; height:38px; line-height:38px;
			...
			background:url(templates/default/images/top_header_hover.png) no-repeat; 
            ...
            #menu-div li.midd_21 {
                ...
                background:url(templates/default/images/midd.png) no-repeat;background-position:10px 13px; border-left:4px #0e94d1 solid; text-indent:12px;

            }

            #menu-div li.midd_22 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -18px;

            }

            #menu-div li.midd_23 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -54px;

            }

            #menu-div li.midd_1 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -93px;

            }

            #menu-div li.midd_2 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -133px;

            }

            #menu-div li.midd_3 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -172px;

            }

            #menu-div li.midd_4 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -208px;

            }

            #menu-div li.midd_5 {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -245px;

            }

            #menu-div li#xinjian_div {

                background:url(templates/default/images/midd.png) no-repeat;background-position:0px -274px;

            }

            #menu-div li span{

                background:url(templates/default/images/numberico.png) no-repeat right bottom; display:inline-block; color:#FFF; font-size:12px; height:18px; padding:0px; text-align:center; line-height:18px; padding-right:8px; margin-left:5px;}

            #menu-div li span em{

                background:url(templates/default/images/numberico.png) no-repeat left top; width:8px;display:inline-block;font-size:12px;  height:18px; vertical-align:top;}
        ...
        <script type="text/javascript">
            ...
            var adminId = "<?php echo self::$_var['admin_id']; ?>";
    ...
    <body>
		...
		<div id="logo-div">
		<?php if (self::$_var['ceshisqlhtml'] == 1): ?>
		<span style="font-size:30px; color:#F00; padding-top:10px;">你现在是测试版本</span>
		<?php else: ?>
		<img src="templates/default/images/ecshop_logo.png" alt="68ECSHOP" /> 
		<?php endif; ?>
		</div>
            ...
            <div id="submenu-div">
                ...
                <ul>
                    <li class="show_9"><a href="index.php?act=login&op=logout" target="_top"><?php echo self::$_var['lang']['signout']; ?></a></li>
					<li class="show_4"><a onclick="clear_cache()"  target="main_frame">清除缓存</a></li>
					...
					<li class="show_1"><a href="http://www.taoyumall.com/" target="_blank"><?php echo self::$_var['lang']['preview']; ?></a></li></ul>

<?php if (self::$_var['send_mail_on'] == 'on'): ?>
                    ...
                    <script type="text/javascript" charset="gb2312">
                        ...
                        var conti = "<?php echo self::$_var['lang']['conti']; ?>";

                        var pause = "<?php echo self::$_var['lang']['pause']; ?>";

                        var counter = 0;

                        var str = "<?php echo self::$_var['lang']['str']; ?>";
                    ...
                    <div id="load-div" style="padding: 5px 0px 0 0; text-align: right; color: #FF9900; display: none;width:20%;float:right; height:68px; line-height:58px;"> <?php echo self::$_var['lang']['loading']; ?></div>
        ...
        <div class="top_mune">
            ...
            <div id="tabbar-div">
                ...
                <?php echo self::$_var['lang']['menu']; ?>

            </div>
			<script>
			function clear_cache(){
				  Ajax.call('index.php?act=index&op=clear_cache','', clear_cache_Response, 'GET', 'text');
			}
			...
			function clear_html(){
				  Ajax.call('index.php?act=index&op=clear_html','', clear_html_Response, 'GET', 'text');
			}
			...
			function clear_index(){
				  Ajax.call('index.php?act=index&op=clear_index','', clear_index_Response, 'GET', 'text');
			}
            ...
            <div id="menu-div">
                ...
                <ul>
                    ...
                    <li class="midd_22"><a href="index.php?act=index&op=main" target="main_frame">起始页</a></li>

                    <!--<li class="midd_23"><a href="privilege.php?act=modif" target="main_frame">设置导航栏</a></li>-->
				    <li class="midd_1"><a href="index.php?act=goods&op=lists" target="main_frame">商品列表<span><em></em><?php echo self::$_var['datainfo']['goods']; ?></span></a></li>
				    <li class="midd_2"><a href="index.php?act=order&op=lists" target="main_frame">订单列表<span><em></em><?php echo self::$_var['datainfo']['order']; ?></span></a></li>
