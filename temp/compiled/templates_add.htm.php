...
<div class="main-div">
    <form method="post" id="form_met" action="index.php?act=mail_templates&op=templates_add" name="theForm" enctype="multipart/form-data" >
        <table cellspacing="1"
cellpadding="3" width="100%">
            ...
            <tr>
               ...
               <td><input type="text" name="tem_key"  maxlength="60" value=""  id="inp1"/><?php echo self::$_var['lang']['require_field']; ?></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="tem_name"  maxlength="60" value="" id="inp2"/><?php echo self::$_var['lang']['require_field']; ?> </td>

            </tr>

            <tr>
                <td class="label"><?php echo self::$_var['lang']['tem_body']; ?>:</td>
                <td><textarea  name="template_content" cols="60" rows="4"  id="inp3">【<?php echo self::$_var['lang']['site_name']; ?>】</textarea><?php echo self::$_var['lang']['dui']; ?>
                </td>
