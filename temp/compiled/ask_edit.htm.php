...
<table cellspacing="1" cellpadding="3" width="100%">
  <tr>
    <td class="label"><?php echo self::$_var['classid']; ?>提问问题</td>
    <td>
        <textarea rows="5" cols="30" name="questions_name" id="questions_name" maxlength="200" ><?php echo self::$_var['askinto']['questions']; ?></textarea><span class="require-field">*</span>
    </td>
</tr>
    ...
    <tr>
        ...
        <td>
            <textarea rows="3" cols="30" name="questions_key" id="questions_key" maxlength="200" ><?php echo self::$_var['askinto']['keyword']; ?></textarea><span class="require-field">*关键字之间用 | 隔开 </span>
        </td>
    </tr>
...
?>
        <option value="<?php echo self::$_var['key']; ?>" <?php if (self::$_var['classid'] == self::$_var['key']): ?>
          selected
        <?php endif; ?>><?php echo self::$_var['cl']; ?></option>
  ...
  <tr>
    ...
    <td><textarea rows="10" cols="30" name="answers_cent" id="answers_cent" maxlength="200" ><?php echo self::$_var['askinto']['answers']; ?></textarea><span class="require-field">*</span>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      ...
      <input type="hidden" name="askid" value="<?php echo self::$_var['askinto']['ask_id']; ?>" />
  </tr>
</table>
</form>
</div>
