...
?>
            <option value="<?php echo self::$_var['key']; ?>" <?php if (self::$_var['site_id'] == self::$_var['key']): ?> selected <?php endif; ?>><?php echo self::$_var['s']; ?></option><?php endforeach; endif; unset($_from); ?><?php self::pop_vars(); ?> <?php endforeach; endif; unset($_from); ?><?php self::pop_vars(); ?></select></td>
      </tr>
      <tr>
        <td class="label">广告图
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="showsd" value="1" <?php if (self::$_var['dcimginto']['showsd'] == 1): ?> checked="true" <?php endif; ?> /><?php echo self::$_var['lang']['is_enabled']; ?>
          <input type="radio" name="showsd" value="0" <?php if (self::$_var['dcimginto']['showsd'] != 1): ?> checked="true" <?php endif; ?> /><?php echo self::$_var['lang']['no_enabled']; ?></td></tr>
      <tr>
        <td class="label">&nbsp;</td>
        <td>
          ...
          <input type="hidden" name="id" value="<?php echo self::$_var['dcimginto']['imgs_id']; ?>" /></td>
      </tr>
    </table>
  </form>
</div>
