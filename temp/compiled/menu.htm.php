...
var noHelp   = "<p align='center' style='color: #666'><?php echo self::$_var['lang']['no_help']; ?></p>";

var helpLang = "<?php echo self::$_var['help_lang']; ?>";
...
.article_menu LI.button_wu A {
	...
	BACKGROUND: url(templates/default/images/menu_bottom.gif) no-repeat 0px 0px;
...
.article_menu LI.button_wu A SPAN {
	...
	BACKGROUND: url(templates/default/images/help_menu-b5.gif) no-repeat;
...
.article_menu LI.button A {
	...
	BACKGROUND: url(templates/default/images/menu_bottom.gif) #e6e6e6 no-repeat center 44px;
...
.article_menu LI.button A em {
	...
	background: url(templates/default/images/allico.png) no-repeat;
...
.article_menu LI.button A SPAN {
	...
	BACKGROUND: url(templates/default/images/help_menu-plus.gif) no-repeat;
...
#menu-ul-suo {
	...
	BACKGROUND: url(templates/default/images/show_right.gif) no-repeat left top;
...
.dropdown LI {
	...
	BACKGROUND: url(templates/default/images/menu_arrow.gif) no-repeat 0px center;
...
<script type="text/javascript" src="<?php echo self::$_var['urls_dir']; ?>/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo self::$_var['urls_dir']; ?>/js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="<?php echo self::$_var['urls_dir']; ?>/js/helpmenu.js"></script>
<script>
...

{
  ...
  imgArrow = parent.drag_frame.document.getElementById('img');
    ...
    imgArrow.src = "templates/default/images/arrow_left.gif";
...
<?php $_from = self::$_var['menus']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; self::push_vars('k', 'menu');if (count($_from)):
    foreach ($_from AS self::$_var['k'] => self::$_var['menu']):
?>

<?php if (self::$_var['menu']['action']): ?>

 <LI class=button_wu><A class=green  href="<?php echo self::$_var['menu']['action']; ?>"><?php echo self::$_var['menu']['label']; ?><SPAN></SPAN></A></LI>

<?php else: ?>

  <li class=button  key="<?php echo self::$_var['k']; ?>" name="menu">

  <A  href="javascript:void(0);"><em  id="h1_<?php echo self::$_var['k']; ?>"></em><?php echo self::$_var['menu']['label']; ?><SPAN id="fa_<?php echo self::$_var['k']; ?>"></SPAN></A></li>

  <li  class="dropdown" id="<?php echo self::$_var['k']; ?>">

     <?php if (self::$_var['menu']['children']): ?>

    <ul>

    <?php $_from = self::$_var['menu']['children']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; self::push_vars('', 'child');if (count($_from)):
    foreach ($_from AS self::$_var['child']):
?>

      <li><a href="<?php echo self::$_var['child']['action']; ?>" target="main_frame"><?php echo self::$_var['child']['label']; ?></a></li>
