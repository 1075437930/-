				...
				<tr>
                                    <td>
                                        <style>
                                            ...
                                            <iframe name="attr_upload" src="index.php?act=img_up&goods_id=<?php echo self::$_var['goods']['goods_id']; ?>" frameborder=1 scrolling=no width="100%" height="auto" style="min-height:630px; border:1px #eee solid; margin-top:5px;"> </iframe>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
...
<script language="JavaScript">
  ...
  function getAttrList(goodsId)
  {
      ...
      if (selGoodsType != undefined)
      {
          ...
          Ajax.call('index.php?act=goods&op=get_attr', 'goods_id=' + goodsId + "&goods_type=" + goodsType, setAttrList, "GET", "JSON");
      }
  }
  ...
  function getTagList(goodsId)
  {
      ...
      if (selGoodsType != undefined)
      {
          ...
          Ajax.call('index.php?act=goods&op=get_tags', 'goods_id=' + goodsId + "&goods_tag=" + goodsType, setTagList, "GET", "JSON");
      }
  }
...
/**
  ...
  */
  function checkGoodsSn(goods_sn, goods_id)
  {
    ...
    Ajax.call('index.php?act=goods&op=check_goods_sn', "goods_sn=" + goods_sn + "&goods_id=" + goods_id, callback, "GET", "JSON");
  }
