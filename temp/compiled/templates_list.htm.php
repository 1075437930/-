...
<div class="form-div">
    <form action="javascript:search_brand()" name="searchForm">
        <img src="templates/default/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
         模板key<input type="text" name="key" size="15" />
         模板名称<input type="text" name="cat_name" size="15" />
...
<script language="JavaScript">
    function search_brand(){
        ...
        listTable.filter['key'] = Utils.trim(document.forms['searchForm'].elements['key'].value);
...
<?php endif; ?>
  <table cellpadding="3" cellspacing="1">
    <tr>
        <th><?php echo self::$_var['lang']['tem_bh']; ?></th>
        <th><?php echo self::$_var['lang']['tem_key']; ?></th>
        <th><?php echo self::$_var['lang']['tem_name']; ?></th>
        <th><?php echo self::$_var['lang']['tem_body']; ?></th>
        <th><?php echo self::$_var['lang']['last_modify']; ?></th>
...
?>
    <tr>
        ...
        <td><?php echo self::$_var['val']['template_id']; ?></td>
        <td><?php echo self::$_var['val']['template_code']; ?></td>
        <td><?php echo self::$_var['val']['template_subject']; ?></td>
        <td><?php echo self::$_var['val']['template_content']; ?></td>
        <td><?php echo self::$_var['val']['last_modify']; ?></td>
        <td>
            <a href="index.php?act=mail_templates&op=templates_edit&template_id=<?php echo self::$_var['val']['template_id']; ?>" title="编辑"><img src="templates/default/images/icon_edit.gif" border="0" height="16" width="16"></a>
            <a href="javascript:" class="dele" template_id="<?php echo self::$_var['val']['template_id']; ?>"   title="移除"><img src="templates/default/images/icon_drop.gif" border="0" height="16" width="16"></a>
...
<script>
    ...
    $(function(){
        $('body').on('click','.dele',function(e){
            var cat_id=$(this).attr('template_id');

            if(confirm('确定删除吗？')){
                location.href="index.php?act=mail_templates&op=templates_del&template_id="+cat_id
            }
