...
<div class="main-div">
    <form method="post" id="form_met" action="index.php?act=attribute&op=attr_edit" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table cellspacing="1" cellpadding="3" width="100%">
            <input type="hidden" name="attr_id_update" value="<?php echo self::$_var['res']['attr_id']; ?>"/>
            <input type="hidden" name="goods_type" value="<?php echo self::$_var['res']['cat_id']; ?>"/>
            <tr>
                <td class="label"><?php echo self::$_var['lang']['edit_name']; ?>:</td>
                <td><input type="text" name="attr_name" id="attr_name" maxlength="60" value="<?php echo self::$_var['res']['attr_name']; ?>" /><?php echo self::$_var['lang']['require_field']; ?></td>
            </tr>
            <tr>
...
?>
                              <?php if (self::$_var['val'] [ cat_id ] == self::$_var['res'] [ cat_id ]): ?>
            ...
            <tr>
                ...
                <td>
                    <?php if (self::$_var['res'] [ is_linked ] == 0): ?>
