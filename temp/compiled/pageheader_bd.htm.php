...
<link href="<?php echo self::$_var['urls_dir']; ?>/styles/main.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="<?php echo self::$_var['urls_dir']; ?>/js/jquery.js"></script>
    <script type="text/javascript" src="<?php echo self::$_var['urls_dir']; ?>/js/jquery.json.js"></script>
    <script type="text/javascript" src="<?php echo self::$_var['urls_dir']; ?>/js/transport_bd.js"></script>
...
<span class="action-span1"><a href="index.php?act=main"><?php echo self::$_var['lang']['cp_home']; ?></a> </span><span id="search_id" class="action-span1"><?php if (self::$_var['ur_here']): ?> - <?php echo self::$_var['ur_here']; ?> <?php endif; ?></span>
