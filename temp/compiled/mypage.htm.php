      ...
      <script>
          $(function(){
              ...
              function chuan(page){
                  ...
                  $.ajax({
                      url:"index.php?act=goods_type&op=manage",
                      ...
                      success:function(rev){
                          ...
                          for(var i = 0;i<json_obj.length;i++){
                              ...
                              $('#trr').before("<tr class='item'><td>"+json_obj[i].cat_name+"</td><td></td><td>"+json_obj[i].attr_count+"</td><td>"+panduan+"</td><td><a href='index.php?act=attribute&op=attr_list&goods_type="+json_obj[i].cat_id+"'>属性列表</a><a href='index.php?act=goods_type&op=goods_type_edit&goods_type="+json_obj[i].cat_id+"'>编辑</a><a href='index.php?act=goods_type&op=goods_type_del&goods_type="+json_obj[i].cat_id+"'>移除</a></td></tr>");
