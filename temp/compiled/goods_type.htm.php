...
<div class="form-div">
    <form action="javascript:search_brand()" name="searchForm">
        ...
        搜索类型 <input type="text" name="cat_name" size="15" />
...
<?php endif; ?>
  <table cellpadding="3" cellspacing="1">
    <tr>
        <th><?php echo self::$_var['lang']['goods_type_name']; ?></th>
        <th><?php echo self::$_var['lang']['goods_type_group']; ?></th>
        <th><?php echo self::$_var['lang']['goods_type_num']; ?></th>
        <th><?php echo self::$_var['lang']['goods_type_zt']; ?></th>
        <th><?php echo self::$_var['lang']['goods_type_cz']; ?></th>
    </tr>
...
?>
    <tr>
        ...
        <td><?php echo self::$_var['val']['cat_name']; ?></td>
        <td><?php echo self::$_var['val']['attr_group']; ?></td>
        <td><?php echo self::$_var['val']['attr_count']; ?></td>
        <?php if (self::$_var['val'] [ enabled ] == 1): ?>
        <td><img src="<?php echo self::$_var['urls_dir']; ?>/images/yes.gif"></td>
        <?php endif; ?>
        <td>
            <a href="index.php?act=attribute&op=attr_list&goods_type=<?php echo self::$_var['val']['cat_id']; ?>">属性列表</a>
            <a href="index.php?act=goods_type&op=goods_type_edit&goods_type=<?php echo self::$_var['val']['cat_id']; ?>">编辑</a>
            <a class="dele" href="javascript:" cat_id="<?php echo self::$_var['val']['cat_id']; ?>">移除</a>
        </td>
    </tr>
    <?php endforeach; else: ?>
...
<script>
    ...
    $(function(){
        $('body').on('click','.dele',function(e){
            ...
            if(confirm('确定删除吗？')){
                location.href="index.php?act=goods_type&op=goods_type_del&goods_type="+cat_id
            }
