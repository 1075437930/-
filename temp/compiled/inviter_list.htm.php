...
<?php endif; ?>
  <table width="100%" cellspacing="1" cellpadding="3">
     <tr>
      <th>
        <a href="javascript:listTable.sort('parent_id'); "><?php echo self::$_var['lang']['record_id']; ?></a><?php echo self::$_var['sort_parent_id']; ?>
      </th>
      <th>邀请人</th>
      <th>手机号</th>
      <th><a href="javascript:listTable.sort('user_count'); ">邀请会员总数</a><?php echo self::$_var['sort_user_count']; ?></th>
      <th>邀请人账户余额</th>
      <th>邀请人淘玉币</th>
      <th>注册日期</th>
      <th>到期时间</th>
...
?>
      <tr align="center">
       ...
       <td><?php echo self::$_var['list']['user_count']; ?></td>
       ...
       <td>
         <a href="index.php?act=inviter&op=info&parent_id=<?php echo self::$_var['list']['user_id']; ?>" title="查看详情" >
