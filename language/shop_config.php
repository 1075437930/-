 ...
 * $Id: shop_config.php 251230 2015-03-19 06:29:08Z taoyu $
...
$_LANG['cfg_name']['duobao_info'] = '夺宝信息';

$_LANG['cfg_name']['ddingzhi_info'] = '定制信息';

$_LANG['cfg_name']['app_info'] = 'app设置';
...
$_LANG['cfg_range']['send_confirm_email']['1'] = '发送通知';

$_LANG['cfg_range']['send_confirm_email']['0'] = '不发送通知';
...
$_LANG['cfg_range']['send_ship_email']['1'] = '发送通知';

$_LANG['cfg_range']['send_ship_email']['0'] = '不发送通知';

$_LANG['cfg_range']['send_cancel_email']['1'] = '发送通知';

$_LANG['cfg_range']['send_cancel_email']['0'] = '不发送通知';

$_LANG['cfg_range']['send_invalid_email']['1'] = '发送通知';

$_LANG['cfg_range']['send_invalid_email']['0'] = '不发送通知';
...
/*fulltext_search_add_START_www.taoyumall.com*/
...
/*fulltext_search_add_END_www.taoyumall.com*/



/* 代码增加_注册红包start  By  www.taoyumall.com */
...
/* 代码增加_注册红包end  By  www.taoyumall.com */



$_LANG['cfg_name']['site_url'] = '官方网址';

$_LANG['cfg_name']['shangjia_mob'] = '平台短信绑定';

$_LANG['cfg_name']['duobao_pic1'] = '轮播图1';

$_LANG['cfg_name']['duobao_pic2'] = '轮播图2';

$_LANG['cfg_name']['kaiguan'] = '夺宝是否开启';

$_LANG['cfg_range']['kaiguan'][0] = '否';

$_LANG['cfg_range']['kaiguan'][1] = '是';

$_LANG['cfg_name']['dingzhi_tel'] = '定制指定短信通知';

$_LANG['cfg_name']['yqfanli'] = '邀请返利点';

$_LANG['cfg_name']['chaopic'] = '完成订单多杀升级vip';
