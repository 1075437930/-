 ...
 * $Id: users.php 251230 2015-03-19 06:29:08Z taoyu $
...
$_LANG['username_error_or_mobile_phone_error'] = '插入数据库时用户名或者密码出现错误。';
...
$_LANG['card_face_upload_fail'] = '身份证正面照上传失败。';

$_LANG['card_back_upload_fail'] = '身份证反面照上传失败。';
